...
registerBlockType('mold/plot', {
    title: __('Plot', 'mold-plot'),
    description: __('Interactive Plot interface', 'mold-plot'),
    icon: {
    ...
    edit: ({ attributes, setAttributes }) => {
        ...
        const plotMetaValue = useSelect((select) => {
        ...
        const displayContent = plotMetaValue || fallback || __('No value set', 'mold-plot');

        return (
            <>
                <InspectorControls>
                    <PanelBody title={__('Content Settings', 'mold-plot')} initialOpen={true}>
                        <SelectControl
                            ...
                            case 'plot_x':
                                return (
                                    <div className='wp-mold-plot-meta' {...blockProps}>
                                        ...
                                        <div>
                                            <small>{__('Meta key:', 'mold-plot')} <code>_{metaKey}</code></small>
                                        </div>
                                    </div>
                                );
                            case 'plot_y':
